...
final class FreeformFieldEntryStub
{
    public function __construct(
        ...
        public string $addButtonMarkup = '',
        public string $removeButtonLabel = '',
        public string $removeButtonMarkup = '',
        public ?FreeformArrayConfigurationStub $optionConfiguration = null,
        public ?FreeformArrayConfigurationStub $tableLayout = null,
    ) {
    }
