...
If you discover a security vulnerability in Translation Manager, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-translation-manager/security/advisories/new). This routes the report directly to maintainers with no public visibility.
