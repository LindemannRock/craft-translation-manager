...
final class HelpController extends AbstractHelpController
{
    ...
    protected function helpManifest(): array
    {
        ...
        $groups = [
            [
                'name' => 'translations',
                'label' => 'Translations',
                'description' => 'Capture, import, and generate translations.',
        ...
        if (FeatureGate::aiTranslationsEnabled()) {
            $common[] = 'debug/test-ai';
            $groups[0]['commands'][] = $this->aiDraftCommand();
            $groups[] = $this->debugCommandGroup();
        }
        ...
        return [
            ...
            'summary' => 'Use these commands to capture translations, generate PHP files, import existing translation files, clean unused rows, and manage backups.',
            'common' => $common,
            'groups' => $groups,
        ];
    }

    private function aiDraftCommand(): array
    {
        return [
    ...
    private function debugCommandGroup(): array
    {
        return [
            'name' => 'debug',
            'label' => 'Debug',
