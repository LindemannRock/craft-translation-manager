...
class ExportController extends Controller
{
    ...
    public function actionFiles(): Response
    {
        ...
        try {
            // Add debugging
            Craft::info('Starting file export', 'translation-manager');
            $exportService = TranslationManager::getInstance()->export;
            $translationsService = TranslationManager::getInstance()->translations;
            
            // Check what's available to export first
            $formieCount = count($translationsService->getTranslations(['type' => 'forms', 'status' => 'translated']));
            $siteCount = count($translationsService->getTranslations(['type' => 'site', 'status' => 'translated']));
