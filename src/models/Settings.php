...
class Settings extends Model
{
    ...
    public function attributeLabels(): array
    {
        return array_merge([
            ...
            'enableAiTranslations' => Craft::t('translation-manager', 'Enable AI Translations'),
            'aiProvider' => Craft::t('translation-manager', 'AI Provider'),
            'openAiApiKey' => Craft::t('translation-manager', 'OpenAI API Key'),
            'openAiModel' => Craft::t('translation-manager', 'OpenAI Model'),
            'geminiApiKey' => Craft::t('translation-manager', 'Gemini API Key'),
