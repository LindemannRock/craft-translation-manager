    ...
    public function safeUp(): bool
    {
        ...
        if (!$this->tableExists('{{%translationmanager_translations}}')) {
            $this->createTable('{{%translationmanager_translations}}', [
                ...
                'status' => $this->enum('status', ['pending', 'draft', 'translated', 'unused'])->notNull()->defaultValue('pending'),
                'translationOrigin' => $this->string(20)->notNull()->defaultValue('system')->comment('Origin of translation text: system|ai|manual|import'),
                'createdByUserId' => $this->integer()->null()->comment('User who created/last set translation content'),
                'reviewedByUserId' => $this->integer()->null()->comment('User who marked row as translated'),
                'reviewedAt' => $this->dateTime()->null()->comment('When row was reviewed/marked translated'),
        ...
        if (!$this->tableExists('{{%translationmanager_settings}}')) {
            $this->createTable('{{%translationmanager_settings}}', [
                ...
                'openAiModel' => $this->string(100)->notNull()->defaultValue('gpt-4o-mini'),
                'geminiApiKey' => $this->string()->null(),
                'geminiModel' => $this->string(100)->notNull()->defaultValue('gemini-2.0-flash'),
                'anthropicApiKey' => $this->string()->null(),
                'anthropicModel' => $this->string(100)->notNull()->defaultValue('claude-3-haiku-20240307'),
                ...
                'runtimeTranslationSource' => $this->string(30)->notNull()->defaultValue('generated-files'),
